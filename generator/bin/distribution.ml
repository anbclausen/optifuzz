...
let random_distribution seed =
  ...
  {    
    ...
    int_lit_p = normalized_arr.(3);
    neg_p = normalized_arr.(4);
    plus_p = normalized_arr.(5);
    minus_p = normalized_arr.(6);
    times_p = normalized_arr.(7);
    true_p = normalized_arr.(8);
    false_p = normalized_arr.(9);
