...
% I propose we add something to the above, describing a "cat and mouse" game, as security researchers actually actively _obfuscate_ their code, such that the compiler won't optimize it.
% So the really important bit is, that what's constant time today might not be constant time tomorrow, and current approaches are sub-optimal to say the least...
