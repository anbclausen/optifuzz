...
\todo{Downside: requires compiler to be configurable and that it's never sneaky (dangerous): Praise clangs configurability. Also hate on gcc's configurability.}
